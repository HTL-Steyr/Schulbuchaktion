...
final class Version20230330093126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS book (id INT AUTO_INCREMENT NOT NULL, subject_id INT DEFAULT NULL, publisher_id INT DEFAULT NULL, main_book_id INT DEFAULT NULL, book_number INT NOT NULL, title VARCHAR(255) NOT NULL, short_title VARCHAR(255) NOT NULL, list_type INT NOT NULL, school_form INT NOT NULL, info VARCHAR(255) DEFAULT NULL, ebook TINYINT(1) NOT NULL, ebook_plus TINYINT(1) NOT NULL, INDEX IDX_CBE5A33123EDC87 (subject_id), INDEX IDX_CBE5A33140C86FCE (publisher_id), INDEX IDX_CBE5A331E2E91A68 (main_book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS book_order (id INT AUTO_INCREMENT NOT NULL, school_class_id INT DEFAULT NULL, book_id INT DEFAULT NULL, count INT NOT NULL, ebook TINYINT(1) NOT NULL, ebook_plus TINYINT(1) NOT NULL, teacher_copy TINYINT(1) NOT NULL, INDEX IDX_FBEB86E114463F54 (school_class_id), INDEX IDX_FBEB86E116A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS book_price (id INT AUTO_INCREMENT NOT NULL, book_id INT NOT NULL, year INT NOT NULL, price_inclusive_ebook INT NOT NULL, price_ebook INT DEFAULT NULL, price_ebook_plus INT DEFAULT NULL, INDEX IDX_C40A37A016A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS department (id INT AUTO_INCREMENT NOT NULL, head_of_department_id INT NOT NULL, name VARCHAR(255) NOT NULL, budget INT NOT NULL, used_budget INT NOT NULL, UNIQUE INDEX UNIQ_CD1DE18AD8CDF922 (head_of_department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS publisher (id INT AUTO_INCREMENT NOT NULL, publisher_number INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS role (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS school_class (id INT AUTO_INCREMENT NOT NULL, department_id INT NOT NULL, name VARCHAR(255) NOT NULL, grade INT NOT NULL, student_amount INT NOT NULL, rep_amount INT NOT NULL, used_budget INT NOT NULL, budget INT NOT NULL, year INT NOT NULL, school_form INT NOT NULL, INDEX IDX_33B1AF85AE80F5DF (department_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS school_grade (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, grade INT NOT NULL, INDEX IDX_87A0182E16A2B381 (book_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS subject (id INT AUTO_INCREMENT NOT NULL, head_of_subject_id INT NOT NULL, name VARCHAR(255) NOT NULL, short_name VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_FBCE3E7ADA200AFE (head_of_subject_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE IF NOT EXISTS `user` (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, short_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, token VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_8D93D649D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
